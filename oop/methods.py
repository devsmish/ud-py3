...
from oop.attributes import client
...
# HOMEWORK
'''Создайте класс BankAccount с атрибутами client_id, client_first_name, client_last_name, balance и методами add() и 
withdraw(), при помощи которых можно пополнять счет и выводить средства со счета соответственно. Атрибут balance должен 
...
class BankAccount:
    ...
    def withdraw(self, outgo):
        if outgo < self.balance:
            self.balance -= outgo
        else:
            print("На балансе недостаточно средств!")

customer = BankAccount(1, "aaa", "mmmmmm")
print(customer.balance)
customer.add(25)
print(customer.balance)
customer.withdraw(18)
print(customer.balance)
customer.withdraw(18)
print(customer.balance)